   ...
   public void loadDemandeData() {
    ...
    private void editDemande(Demande demande) {
        try {
            ...
            e.printStackTrace();
            Modals.displayError("Erreur", "Impossible d'ouvrir la fenêtre de modification.");
        }
    }
    ...
    private void deleteDemande(Demande demande) {
        try {
            ...
            loadDemandeData();
            Modals.displaySuccess("Suppression", "Demande supprimée avec succès.");
        } catch (SQLException e) {
            e.printStackTrace();
            Modals.displayError("Erreur", "Impossible de supprimer la demande.");
        }
    }

    private void showDemandeDetail(Demande demande) {
        Modals.displaySuccess("Détail de la Demande", demande.toString());
    }
    private void showTraitementDetails(int idDemande) {
        try {
            ...
            e.printStackTrace();
            Modals.displayError("Erreur", "Impossible d'ouvrir la fenêtre du traitement.");
        }
    }
}
