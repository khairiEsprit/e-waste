...
public class poubelle {
    ...
    public poubelle(int id, int id_centre, String adresse, int niveau, com.example.ewaste.Entities.etat etat, Date date_installation) {
        this.id = id;
    ...
    public poubelle(int id_centre, String adresse, int niveau, com.example.ewaste.Entities.etat etat, Date date_installation) {
        this.id_centre = id_centre;
        this.adresse = adresse;
        this.niveau = niveau;
        this.etat = etat;
