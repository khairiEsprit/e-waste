...
public class CentreListCellController extends ListCell<Centre> {
    ...
    protected void updateItem(Centre centre, boolean empty) {
        ...
        if (empty || centre == null) {
            ...
            Label AltitudeLabel = new Label("📍 Altitude: " + centre.getLatitude());
            ...
            LongitudeLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: #555;");
            AltitudeLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: #555;");
            ...
            VBox vbox = new VBox(idLabel, nomLabel, LongitudeLabel,AltitudeLabel, telephoneLabel, emailLabel);
